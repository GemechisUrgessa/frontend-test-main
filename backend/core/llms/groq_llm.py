        ...
        while True:
            ...
            if gathered.get("tool_calls"):
                ...
                if gathered.get("content"):
                    for element in gathered["content"]:
                        if element.get("type") == "text":
                            content = element["text"]



                chat_history.add_tool_calls_message(content=content, tool_calls=gathered["tool_calls"])
            else:
                if gathered.get("content"):
                    chat_history.add_assistant_message(gathered["content"][0]["text"])
